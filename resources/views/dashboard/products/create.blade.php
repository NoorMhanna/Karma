            ...
            <form method="POST" action="{{ route('dashboard.products.store') }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"  value="{{old('description')}}" class="form-control" id="exampleInputEmail1" name="description"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.1"  value="{{old('price')}}" class="form-control" id="exampleInputEmail1" name="price"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number"   value="{{old('quantity')}}" class="form-control" id="exampleInputEmail1" name="quantity"
